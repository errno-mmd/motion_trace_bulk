@echo off
rem --- 
rem ---  Estimate postures with tf-pose-estimation from image data
rem --- 


echo ------------------------------------------
echo tf-pose-estimation analysis
echo ------------------------------------------
...
echo Specify the frame number (0 starting) that is inverted by tf-pose-estimation by mistake, the person INDEX order, and the contents of the inversion.
echo In the order that tf-pose-estimation recognizes at 0F, INDEX is assigned as 0, 1, ....
...
echo --------------
echo tf-pose-estimation Start analysis.
...
echo --------------
echo Done!!
echo tf-pose-estimation analysis end
